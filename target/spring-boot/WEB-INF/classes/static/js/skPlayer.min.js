			...
			l = function() {
				...
				return r(t, [{
					...
					value: function() {
						...
						}, this.audio = this.root.querySelector(".skPlayer-source"), this.option.listshow && (this.root.className = "skPlayer-list-on"), "singleloop" === this.option.mode && (this.audio.loop = !0), this.dom.musicitem[0].className = "skPlayer-curMusic", "cloud" === this.type && this.RandomMusic()
					}
				}, {
					key: "bind",
					value: function() {
					...
					value: function() {
						var e = this;
						var t = e.music.length;
						if(t > 1) {
							while(true) {
								var r = parseInt(t * Math.random());
								if(r != t) {
									t = r;
									break;
								}
					...
					key: "stop",
					value: function() {
						this.audio.paused || (this.audio.pause(), this.audio.url = '', this.dom.playbutton.classList.remove("skPlayer-pause"), this.dom.cover.classList.remove("skPlayer-pause"))
					}
				}, {
					key: "toggle",
					value: function() {
